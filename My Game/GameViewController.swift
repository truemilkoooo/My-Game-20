...
//  My Game
//
//  Created by Вова Пупкин on 23.10.2020.
//
...
class GameViewController: UIViewController {
    ...
    func addShip() {
        ...
        //Animate ship movement towards camera ship.runAction(SCNAction.repeatForever(SCNAction.rotateBy(x: 0, y: 2, z: 0, duration: 1)))
